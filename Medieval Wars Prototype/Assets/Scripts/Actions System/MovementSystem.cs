    ...
    public void GetWalkableTiles(Unit unit)
    {
        ...
        while (queue.Count > 0)
        {
            ...
            if ((y - 1 >= 0 && y - 1 < MapGrid.Instance.Rows && x >= 0 && x < MapGrid.Instance.Columns) && temp.moveleft > 0 && !(MapGrid.Instance.grid[y - 1, x].isWalkable))
            {
                ...
                // int moveleft = temp.moveleft - 1;//TerrainsUtil.MoveCost[MapGrid.Instance.Instance.grid[y - 1,x].occupantTerrain.TerrainIndex, unit.unitIndex];
                // int moveleft = temp.moveleft - TerrainsUtils.GetMoveCost(MapGrid.Instance.Instance.grid[y - 1, x].occupantTerrain, unit);
                ...
                if (moveleft >= 0)
                {
                    ...
                    if ((MapGrid.Instance.grid[y - 1, x].occupantUnit is UnitTransport unitTransport && unitTransport.loadedUnit == null) || MapGrid.Instance.grid[y - 1, x].occupantUnit == null)
                    {
            ...
            {
                // int moveleft = temp.moveleft - 1;// TerrainsUtil.MoveCost[MapGrid.Instance.Instance.grid[y , x + 1].occupantTerrain.TerrainIndex, unit.unitIndex];
                ...
                if (moveleft >= 0)
                {
                    ...
                    if ((MapGrid.Instance.grid[y, x + 1].occupantUnit is UnitTransport unitTransport && unitTransport.loadedUnit == null) || MapGrid.Instance.grid[y, x + 1].occupantUnit == null)
                    {
